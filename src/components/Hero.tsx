  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-6">
        <a
          href="#about"
          className="px-6 py-3 bg-white text-blue-600 rounded-lg shadow-lg hover:bg-blue-100 transition bg-warmyellow"
        >
          Get to know me
        </a>
        <a
          href="#contact"
          className="px-6 py-3 bg-transparent border border-white rounded-lg shadow-lg hover:bg-white hover:text-blue-600 transition bg-seablue"
        >
